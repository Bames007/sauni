...
const baseUrl = "https://sauni.edu.ng";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      ...
      {
        url: "/sauni-logo-square.png", // Optional: square version for some platforms
        width: 600,
        height: 600,
        alt: "Southern Atlantic University Logo",
        type: "image/png",
  ...
  twitter: {
    ...
    description:
      "Where education is a transformative journey. Empowering students to make a difference.",
    creator: "@SAUniversity", // Add your Twitter handle if you have one
    images: ["/sauni-logo.png"],
  },
  icons: {
    icon: "/favicon.ico",
